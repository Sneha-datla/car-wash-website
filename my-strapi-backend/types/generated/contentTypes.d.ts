...
export interface ApiAllServieAllServie extends Struct.CollectionTypeSchema {
  collectionName: 'all_servies';
  info: {
    description: '';
    displayName: 'AllServie';
    pluralName: 'all-servies';
    singularName: 'all-servie';
  };
  options: {
...
export interface ApiBlogClassicBlogClassic extends Struct.CollectionTypeSchema {
  collectionName: 'blog_classics';
  info: {
    description: '';
    displayName: 'BlogClassic';
    pluralName: 'blog-classics';
    singularName: 'blog-classic';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BookingDate: Schema.Attribute.String;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Booking: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured_tag: Schema.Attribute.String;
    image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    option_id: Schema.Attribute.String;
    option_value: Schema.Attribute.String;
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    tax_rate: Schema.Attribute.Relation<'oneToOne', 'api::tax-rate.tax-rate'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTaxRateTaxRate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Taxrate: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamDataTeamData extends Struct.CollectionTypeSchema {
  collectionName: 'team_datas';
  info: {
    description: '';
    displayName: 'Team Data';
    pluralName: 'team-datas';
    singularName: 'team-data';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Relation<'manyToOne', 'api::team-data.team-data'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::all-servie.all-servie': ApiAllServieAllServie;
      'api::blog-classic.blog-classic': ApiBlogClassicBlogClassic;
      ...
      'api::team-data.team-data': ApiTeamDataTeamData;
